...
export const workLocations = ['Head Office', 'Clifton Branch', 'Remote'];
...
export const dutyRosterData: DutyRoster[] = [
  ...
  {
    id: 'DR003', empId: 'EMP004', empName: 'Fatima Raza', department: 'Marketing', date: '2026-05-07',
    shift: 'Morning Shift', startTime: '09:00', endTime: '18:00', location: 'Clifton Branch',
...
export const allAttendanceToday = [
  ...
  { empId: 'EMP004', name: 'Fatima Raza', dept: 'Marketing', branch: 'Clifton Branch', shift: 'Morning Shift', expectedIn: '09:00', checkIn: '-', checkOut: '-', status: 'On Leave', lateBy: '', notes: 'Annual Leave', state: 'submitted', markedBy: 'HR1', markedAt: '2026-05-09T09:30:00Z', submittedAt: '2026-05-09T18:00:00Z', acknowledgedAt: null },
  { empId: 'EMP005', name: 'Bilal Ahmed', dept: 'Finance', branch: 'Clifton Branch', shift: 'Night Shift', expectedIn: '22:00', checkIn: '-', checkOut: '-', status: 'Absent', lateBy: '', notes: '', state: 'submitted', markedBy: 'HR1', markedAt: '2026-05-09T09:30:00Z', submittedAt: '2026-05-09T18:00:00Z', acknowledgedAt: null },
];
...
export const penalties = [
  ...
  { id: 'PN002', empId: 'EMP004', empName: 'Fatima Raza', branch: 'Clifton Branch', type: 'Policy breach', amount: 1500, date: '2026-04-12', appliedBy: 'Branch Manager', status: 'Active', workflowStatus: 'ho_pending' },
  { id: 'PN003', empId: 'EMP005', empName: 'Bilal Ahmed', branch: 'Clifton Branch', type: 'Unapproved absence', amount: 1800, date: '2026-04-20', appliedBy: 'HR1', status: 'Active', workflowStatus: 'approved' },
];
...
export const hrAccounts = [
  { id: 'ACC001', username: 'superadmin', role: 'super_admin', title: 'Super Admin', password: 'admin123', linkedEmployee: '-', departments: ['All'], branch: 'All', status: 'Active', created: '2020-01-01' },
  { id: 'ACC002', username: 'headhr', role: 'hr', title: 'Head HR', password: 'head123', linkedEmployee: 'EMP003 - Usman Malik', departments: ['All'], branch: 'All', status: 'Active', created: '2021-03-10' },
  { id: 'ACC003', username: 'branchhr', role: 'hr', title: 'Branch HR', password: 'branch123', linkedEmployee: 'EMP002 - Sara Khan', departments: ['All'], branch: 'Clifton Branch', status: 'Active', created: '2021-03-15' },
  { id: 'ACC004', username: 'deptshr', role: 'hr', title: 'Department HR', password: 'depts123', linkedEmployee: 'EMP004 - Fatima Raza', departments: ['Marketing'], branch: 'Clifton Branch', status: 'Active', created: '2021-03-16' },
];
